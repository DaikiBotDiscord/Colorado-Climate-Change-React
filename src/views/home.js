    ...
    <div className="home-container">
      ...
      <div className="home-container01">
        ...
        <div className="home-stats1">
          <div className="home-stat4">
            <h1 className="home-text046">99°F</h1>
            <span className="home-text047">
              <span>#1 Hottest Cities</span>
              <br></br>
            </span>
            <span className="home-text050">Grand Junction, Pueblo</span>
          </div>
          <div className="home-stat5">
            <h1 className="home-text051">96°F</h1>
            <span className="home-text052">
              <span className="home-text053">#2 Hottest City</span>
              <br></br>
            </span>
            <span className="home-text055">Greeley</span>
          </div>
          <div className="home-stat6">
            <h1 className="home-text056">94°F</h1>
            <span className="home-text057">
              <span>#3 Hottest Cities</span>
              <br></br>
            </span>
            <span className="home-text060">Denver, Montrose</span>
          </div>
          <div className="home-stat7">
            <h1 className="home-text061">93-90°F</h1>
      ...
      <div className="home-hero1">
        <div className="home-container02">
          <h1 className="home-text068">Precipitation Risk in Colorado</h1>
          <span className="home-text069">
            <span className="home-text070">Denver</span>
            ...
            <br></br>
            <br></br>
            <span className="home-text075">Durango</span>
            <span>
              {' '}
      ...
      <div className="home-hero2">
        ...
        <div className="home-container03">
          <h1 className="home-text082">Fire Risk in Colorado</h1>
          <span className="home-text083">
            ...
            <span className="home-text085">red flag warning</span>
            <span>
      ...
      <div className="home-container04">
        <h1 id="challenges" className="home-text092">
          <span>
          ...
          <div className="home-container05">
            <div className="home-container06">
              <div className="home-container07">
                <div className="home-testimonial-card">
                  <div className="home-testimonial1">
                    ...
                    <h1 className="home-text095">Wildfires</h1>
                    <span className="home-text096">
                      <span>
                        Long periods of high temperatures create a favorable
                        environment for wildfires. Colorado has been seeing an
                        increase in the frequency and intensity of wildfires.
                        These wildfires are posing a threat to ecosystems,
              ...
              <div className="home-testimonial-card1">
                <div className="home-testimonial2">
                  ...
                  <h1 className="home-text099">
                    <span>Air Quality</span>
                    <br></br>
                  </h1>
                  <span className="home-text102">
                    <span>
                      Any sort of change in our climate can affect air quality,
                      especially in urban areas. Higher temperatures and
                      precipitation may contribute to the form of ground-level
                      ozone and particulate matter. This will affect respiratory
            ...
            <div className="home-container08">
              <div className="home-testimonial-card2">
                ...
                <h1 className="home-text105">Water Scarcity</h1>
                <span className="home-text106">
                  <span>
                    Colorado has had a mass change in precipitation patterns
                    with warmer temperatures. This can affect the availability
                    of water and affect snowpacks. Colorado relies on the
                    snowmelt for water supply, and if any drastic changes to the
                    snowmelt will lead to water scarcity
                  </span>
                  <br></br>
                </span>
              </div>
      ...
      <div className="home-gallery">
        <div className="home-gallery-card">
          ...
          <span className="home-text112">208,913 Acres Burned, 2020</span>
        </div>
        <div className="home-gallery-card1">
          ...
          />
          <h2 className="home-text113">East Troublesome</h2>
          <span className="home-text114">193,812 Acres, 2020</span>
        </div>
        <div className="home-gallery-card2">
          ...
          />
          <h2 className="home-text115">Pine Gulch</h2>
          <span className="home-text116">139,007 Acres, 2020</span>
        </div>
        <div className="home-gallery-card3">
          ...
          />
          <h2 className="home-text117">Marshall Fire</h2>
          <span className="home-text118">1,084 Homes Lost, 2021</span>
        </div>
        <div className="home-gallery-card4">
          ...
          />
          <h2 className="home-text119">Waldo Canyon</h2>
        ...
        <div className="home-gallery-card5">
          ...
          />
          <h2 className="home-text123">Black Forest</h2>
      ...
      <div className="home-blog">
        <h1 id="solutions" className="home-text127">
        ...
        <div className="home-container09">
          <div className="home-blog-post-card">
            ...
            <div className="home-container10">
              <h1 className="home-text130">Water Scarcity</h1>
        ...
        <div className="home-container12">
          <div className="home-blog-post-card1">
            ...
            <div className="home-container13">
              <h1 className="home-text135">Air Quality</h1>
        ...
        <div className="home-blog-post-card2">
          ...
          <div className="home-container15">
            <h1 className="home-text140">Wildfires</h1>
      ...
      <div className="home-features">
        <h1 id="sources" className="home-text147">
          Sources Used
        </h1>
        <div className="home-container17">
          ...
          <div className="home-feature-card2">
            ...
            <div className="home-container20">
              ...
              >
                <h2 className="home-text158">The Nature Conservancy</h2>
              </a>
              <span>
