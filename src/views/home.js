    ...
    <div className="home-container">
      ...
      <div className="home-hero2">
        ...
        <div className="home-container03">
          <h1 className="home-text080">Fire Risk in Colorado</h1>
          <span className="home-text081">
            ...
            <span className="home-text083">red flag warning</span>
            <span>
      ...
      <div className="home-container04">
        <h1 id="challenges" className="home-text090">
          <span>
          ...
          <div className="home-container05">
              ...
              <div className="home-container07">
                <div className="home-testimonial-card">
                  <div className="home-testimonial1">
                    ...
                    <h1 className="home-text093">Wildfires</h1>
            ...
            <div className="home-container08">
              <div className="home-testimonial-card2">
                ...
                <h1 className="home-text099">Water Scarcity</h1>
      ...
      <div className="home-gallery">
        <div className="home-gallery-card">
          ...
          <span className="home-text104">208,913 Acres Burned, 2020</span>
        </div>
        <div className="home-gallery-card1">
          ...
          />
          <h2 className="home-text105">East Troublesome</h2>
          <span className="home-text106">193,812 Acres, 2020</span>
        </div>
        <div className="home-gallery-card2">
          ...
          />
          <h2 className="home-text107">Pine Gulch</h2>
          <span className="home-text108">139,007 Acres, 2020</span>
        </div>
        <div className="home-gallery-card3">
          ...
          />
          <h2 className="home-text109">Marshall Fire</h2>
          <span className="home-text110">1,084 Homes Lost, 2021</span>
        </div>
        <div className="home-gallery-card4">
          ...
          />
          <h2 className="home-text111">Waldo Canyon</h2>
        ...
        <div className="home-gallery-card5">
          ...
          />
          <h2 className="home-text115">Black Forest</h2>
      ...
      <div className="home-blog">
        <h1 id="solutions" className="home-text119">
        ...
        <div className="home-container09">
          <div className="home-blog-post-card">
            ...
            <div className="home-container10">
              <h1 className="home-text122">Water Scarcity</h1>
        ...
        <div className="home-container12">
          <div className="home-blog-post-card1">
            ...
            <div className="home-container13">
              <h1 className="home-text127">Air Quality</h1>
        ...
        <div className="home-blog-post-card2">
          ...
          <div className="home-container15">
            <h1 className="home-text130">Wildfires</h1>
      ...
      <div className="home-features">
        <h1 id="sources" className="home-text135">
          Sources Used
        </h1>
        <div className="home-container17">
          ...
          <div className="home-feature-card2">
            ...
            <div className="home-container20">
              ...
              >
                <h2 className="home-text146">The Nature Conservancy</h2>
              </a>
              <span>
