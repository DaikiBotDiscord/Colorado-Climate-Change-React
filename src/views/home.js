    ...
    <div className="home-container">
      ...
      <div className="home-container01">
        ...
        <div className="home-stats">
          <div className="home-stat">
            <h1 className="home-text009">#11</h1>
          ...
          <div className="home-stat1">
            <h1 className="home-text017">#23</h1>
            <span className="home-text018">Heat Risk</span>
          ...
          <div className="home-stat2">
            <h1 className="home-text023">#42</h1>
            <span className="home-text024">
              <span className="home-text025">Storm Risk</span>
              <br></br>
            </span>
          ...
          <div className="home-stat3">
            <h1 className="home-text031">#43</h1>
            <span className="home-text032">
              <span className="home-text033">Flood Risk</span>
              <br></br>
            </span>
        ...
        <div className="home-stats1">
          <div className="home-stat4">
            <h1 className="home-text048">99°F</h1>
            <span className="home-text049">
              <span>#1 Hottest Cities</span>
              <br></br>
            </span>
            <span className="home-text052">Grand Junction, Pueblo</span>
          </div>
          <div className="home-stat5">
            <h1 className="home-text053">96°F</h1>
            <span className="home-text054">
              <span className="home-text055">#2 Hottest City</span>
              <br></br>
            </span>
            <span className="home-text057">Greeley</span>
          </div>
          <div className="home-stat6">
            <h1 className="home-text058">94°F</h1>
            <span className="home-text059">
              <span>#3 Hottest Cities</span>
              <br></br>
            </span>
            <span className="home-text062">Denver, Montrose</span>
          </div>
          <div className="home-stat7">
            <h1 className="home-text063">93-90°F</h1>
      ...
      <div className="home-hero1">
        <div className="home-container02">
          <h1 className="home-text070">Precipitation Risk in Colorado</h1>
          <span className="home-text071">
            <span className="home-text072">Denver</span>
            ...
            <br></br>
            <br></br>
            <span className="home-text077">Durango</span>
            <span>
              {' '}
            ...
            <span>(</span>
            <a
              href="https://climatecheck.com/colorado#:~:text=Historically%2C%20Denver%20experienced%20an%20average,about%209%20times%20per%20year."
              target="_blank"
              rel="noreferrer noopener"
      ...
      <div className="home-hero2">
        ...
        <div className="home-container03">
          <h1 className="home-text084">Fire Risk in Colorado</h1>
          <span className="home-text085">
            <span>
              &quot;Fire risk depends on the type of vegetation and other land
              cover in the area, and topography. Fire risk is greatly increased
            ...
            <span className="home-text087">red flag warning</span>
            <span>
              , when heat, low humidity, and strong winds converge.&quot; (
            </span>
            <a
              href="https://climatecheck.com/colorado#:~:text=Fire%20Risk%20in%20Colorado%20with,humidity%2C%20and%20strong%20winds%20converge."
              target="_blank"
              rel="noreferrer noopener"
      ...
      <div className="home-container04">
        <h1 id="challenges" className="home-text094">
          <span>
          ...
          <div className="home-container05">
            <div className="home-container06">
              <div className="home-container07">
                <div className="home-testimonial-card">
                  <div className="home-testimonial1">
                    ...
                    <h1 className="home-text097">Wildfires</h1>
                    <span className="home-text098">
                      <span>
                        Long periods of high temperatures create a favorable
                        environment for wildfires. As Colorado temperatures are
                        rising, it is having a big impact on tree health, lack
                        of precipitation and other factors that can contribute
                        to a fire risk
                        <span
                          dangerouslySetInnerHTML={{
                            __html: ' ',
                      ...
                      <a
                        href="https://www.nature.org/en-us/about-us/where-we-work/united-states/colorado/stories-in-colorado/forests-rivers-climate-change/#:~:text=As%20the%20world%20warms%2C%20the,that%20contribute%20to%20fire%20risk."
                        target="_blank"
                        rel="noreferrer noopener"
              ...
              <div className="home-testimonial-card1">
                <div className="home-testimonial2">
                  ...
                  <h1 className="home-text101">
                    <span>Air Quality</span>
                    <br></br>
                  </h1>
                  <span className="home-text104">
                    <span>
                      Any change in out climate can affect air quality.
                      &quot;Colorado’s changing climate and rising temperatures
                      are in part what is contributing to the polluted
                      air.&quot;
                      <span
                        dangerouslySetInnerHTML={{
                          __html: ' ',
                    ...
                    <span>
                      This will affect respiratory health and overall air
                      quality.
                    </span>
                    <br></br>
                  </span>
            ...
            <div className="home-container08">
              <div className="home-testimonial-card2">
                ...
                <h1 className="home-text108">Water Scarcity</h1>
                <span className="home-text109">
                  <span>
                    Colorado has had a mass change in precipitation patterns
                    with warmer temperatures. This can affect the availability
                    of water and affect snowpacks. One of the many water
                    supplies for Colorado comes from snowmelt.
                  </span>
                  <br></br>
                </span>
              </div>
      ...
      <div className="home-gallery">
        <div className="home-gallery-card">
          ...
          <span className="home-text115">208,913 Acres Burned, 2020</span>
        </div>
        <div className="home-gallery-card1">
          ...
          />
          <h2 className="home-text116">East Troublesome</h2>
          <span className="home-text117">193,812 Acres, 2020</span>
        </div>
        <div className="home-gallery-card2">
          ...
          />
          <h2 className="home-text118">Pine Gulch</h2>
          <span className="home-text119">139,007 Acres, 2020</span>
        </div>
        <div className="home-gallery-card3">
          ...
          />
          <h2 className="home-text120">Marshall Fire</h2>
          <span className="home-text121">1,084 Homes Lost, 2021</span>
        </div>
        <div className="home-gallery-card4">
          ...
          />
          <h2 className="home-text122">Waldo Canyon</h2>
        ...
        <div className="home-gallery-card5">
          ...
          />
          <h2 className="home-text126">Black Forest</h2>
      ...
      <div className="home-blog">
        <h1 id="solutions" className="home-text130">
        ...
        <div className="home-container09">
          <div className="home-blog-post-card">
            ...
            <div className="home-container10">
              <h1 className="home-text133">Water Scarcity</h1>
        ...
        <div className="home-container12">
          <div className="home-blog-post-card1">
            ...
            <div className="home-container13">
              <h1 className="home-text138">Air Quality</h1>
        ...
        <div className="home-blog-post-card2">
          ...
          <div className="home-container15">
            <h1 className="home-text143">Wildfires</h1>
            <span className="home-text144">
              <span>
                To prevent wildfires in Colorado, the DFPC has been producing
                fire bans in certain areas that may be prone to having a fire
                due to dry environment, or low precipitation. They also have a
                lot of tips of wildfire prevention on the
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
                  }}
              ...
              <a
                href="https://dfpc.colorado.gov/communityfireprep"
                target="_blank"
                rel="noreferrer noopener"
      ...
      <div className="home-features">
        <h1 id="sources" className="home-text148">
          Sources Used
        </h1>
        <div className="home-container17">
          ...
          <div className="home-feature-card2">
            ...
            <div className="home-container20">
              ...
              >
                <h2 className="home-text159">The Nature Conservancy</h2>
              </a>
              <span>
